                                ...
                                progress:(BADownloadProgress)progress
{
     ...
     *  设置下请求的解析器
     */
    if ([URLString isEqualToString:BASEURL(@"/likeu/chooseanswer")] ||
//        [URLString isEqualToString:BASEURL(@"/user/register")] ||
        [URLString isEqualToString:BASEURL(@"/user/updatesurvey")] ||
        [URLString isEqualToString:BASEURL(@"/chat/breakup")] ||
        [urlString isEqualToString:BASEURL(@"/comment/delete")] ||
        [urlString isEqualToString:BASEURL(@"/user/changetelnumber")] ||
        [urlString isEqualToString:BASEURL(@"/alipay/pay")] ||
        [URLString isEqualToString:BASEURL(@"/match/send")] ||
        [URLString isEqualToString:BASEURL(@"/user/deleteimg")])
    {
        [self sharedAFManager].requestSerializer = [AFHTTPRequestSerializer serializer];
    } else{
        ...
        [imageArray enumerateObjectsUsingBlock:^(id  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
            ...
            {   // 图片数据不为空才传递 fileName
                ...
                [formData appendPartWithFileData:imgData
                                            name:@"file"
                                        fileName:[NSString stringWithFormat:@"picflie%ld.jpg",(long)idx]
                                        mimeType:@"image/jpeg"];
